    ...
    <div class="btn-toolbar justify-content-between" role="toolbar">
      ...
      <div class="justify-content-end">
        <form class="form-inline">
          ...
          <label class="sr-only" for="phone-search">手机号</label>
          <input
            type="text"
            class="form-control mb-2 mr-sm-2"
            id="phone-search"
            placeholder="请输入手机号"
            v-model="pageInfo.otherParam.phone"
          />

          <label class="sr-only" for="email-search">邮箱</label>
          <input
            type="text"
            class="form-control mb-2 mr-sm-2"
            id="email-search"
            placeholder="请输入邮箱"
            v-model="pageInfo.otherParam.email"
          />
